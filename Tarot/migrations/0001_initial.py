    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_page', models.ImageField(blank=True, null=True, upload_to='static/cover_pages/')),
                ('tarot_role', models.CharField(default='Tarot Reading and AStrology', max_length=50)),
